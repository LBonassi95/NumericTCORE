...
(:constraints (and (sometime (>= (x farm0) 100))
(sometime (>= (x farm2) 100))
(sometime (>= (x farm3) 100))
(sometime (>= (x farm4) 100))
(sometime (>= (x farm5) 100))
(sometime (>= (x farm6) 100))
(sometime (>= (x farm7) 100))
(always (>= (+ (x farm0) (+ (x farm1) (+ (x farm2) (+ (x farm3) (+ (x farm4) (+ (x farm5) (+ (x farm6) (x farm7)))))))) (* 403.0 0.9)))))
