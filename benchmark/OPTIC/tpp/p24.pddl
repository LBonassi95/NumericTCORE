...
(:constraints (and (within 0.176 (>= (bought goods0) (request goods0)))
(within 0.176 (>= (bought goods1) (request goods1)))
(within 0.176 (>= (bought goods2) (request goods2)))
(within 0.176 (>= (bought goods3) (request goods3)))
(within 0.368 (>= (bought goods4) (request goods4)))
(within 0.368 (>= (bought goods5) (request goods5)))
(within 0.368 (>= (bought goods6) (request goods6)))
(within 0.368 (>= (bought goods7) (request goods7)))
(within 0.5680000000000001 (>= (bought goods8) (request goods8)))
(within 0.5680000000000001 (>= (bought goods9) (request goods9)))
(within 0.5680000000000001 (>= (bought goods10) (request goods10)))
(within 0.5680000000000001 (>= (bought goods11) (request goods11)))
(within 0.744 (>= (bought goods12) (request goods12)))
(within 0.744 (>= (bought goods13) (request goods13)))
(within 0.744 (>= (bought goods14) (request goods14)))
(within 0.744 (>= (bought goods15) (request goods15)))
(within 0.9440000000000001 (>= (bought goods16) (request goods16)))
(within 0.9440000000000001 (>= (bought goods17) (request goods17)))
(within 0.9440000000000001 (>= (bought goods18) (request goods18)))
(within 0.9440000000000001 (>= (bought goods19) (request goods19)))
(within 1.1360000000000001 (>= (bought goods20) (request goods20)))
(within 1.1360000000000001 (>= (bought goods21) (request goods21)))
(within 1.1360000000000001 (>= (bought goods22) (request goods22)))
(within 1.1360000000000001 (>= (bought goods23) (request goods23)))))
