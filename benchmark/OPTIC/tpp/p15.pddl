...
(:constraints (and (within 0.112 (>= (bought goods0) (request goods0)))
(within 0.112 (>= (bought goods1) (request goods1)))
(within 0.112 (>= (bought goods2) (request goods2)))
(within 0.112 (>= (bought goods3) (request goods3)))
(within 0.216 (>= (bought goods4) (request goods4)))
(within 0.216 (>= (bought goods5) (request goods5)))
(within 0.216 (>= (bought goods6) (request goods6)))
(within 0.216 (>= (bought goods7) (request goods7)))
(within 0.328 (>= (bought goods8) (request goods8)))
(within 0.328 (>= (bought goods9) (request goods9)))
(within 0.328 (>= (bought goods10) (request goods10)))
(within 0.328 (>= (bought goods11) (request goods11)))
(within 0.418 (>= (bought goods12) (request goods12)))
(within 0.418 (>= (bought goods13) (request goods13)))
(within 0.418 (>= (bought goods14) (request goods14)))))
