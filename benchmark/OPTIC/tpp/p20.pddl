...
(:constraints (and (within 0.2 (>= (bought goods0) (request goods0)))
(within 0.2 (>= (bought goods1) (request goods1)))
(within 0.2 (>= (bought goods2) (request goods2)))
(within 0.2 (>= (bought goods3) (request goods3)))
(within 0.2 (>= (bought goods4) (request goods4)))
(within 0.4 (>= (bought goods5) (request goods5)))
(within 0.4 (>= (bought goods6) (request goods6)))
(within 0.4 (>= (bought goods7) (request goods7)))
(within 0.4 (>= (bought goods8) (request goods8)))
(within 0.4 (>= (bought goods9) (request goods9)))
(within 0.59 (>= (bought goods10) (request goods10)))
(within 0.59 (>= (bought goods11) (request goods11)))
(within 0.59 (>= (bought goods12) (request goods12)))
(within 0.59 (>= (bought goods13) (request goods13)))
(within 0.59 (>= (bought goods14) (request goods14)))
(within 0.77 (>= (bought goods15) (request goods15)))
(within 0.77 (>= (bought goods16) (request goods16)))
(within 0.77 (>= (bought goods17) (request goods17)))
(within 0.77 (>= (bought goods18) (request goods18)))
(within 0.77 (>= (bought goods19) (request goods19)))))
