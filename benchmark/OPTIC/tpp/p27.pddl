...
(:constraints (and (within 0.224 (>= (bought goods0) (request goods0)))
(within 0.224 (>= (bought goods1) (request goods1)))
(within 0.224 (>= (bought goods2) (request goods2)))
(within 0.224 (>= (bought goods3) (request goods3)))
(within 0.448 (>= (bought goods4) (request goods4)))
(within 0.448 (>= (bought goods5) (request goods5)))
(within 0.448 (>= (bought goods6) (request goods6)))
(within 0.448 (>= (bought goods7) (request goods7)))
(within 0.68 (>= (bought goods8) (request goods8)))
(within 0.68 (>= (bought goods9) (request goods9)))
(within 0.68 (>= (bought goods10) (request goods10)))
(within 0.68 (>= (bought goods11) (request goods11)))
(within 0.92 (>= (bought goods12) (request goods12)))
(within 0.92 (>= (bought goods13) (request goods13)))
(within 0.92 (>= (bought goods14) (request goods14)))
(within 0.92 (>= (bought goods15) (request goods15)))
(within 1.1520000000000001 (>= (bought goods16) (request goods16)))
(within 1.1520000000000001 (>= (bought goods17) (request goods17)))
(within 1.1520000000000001 (>= (bought goods18) (request goods18)))
(within 1.1520000000000001 (>= (bought goods19) (request goods19)))
(within 1.572 (>= (bought goods20) (request goods20)))
(within 1.572 (>= (bought goods21) (request goods21)))
(within 1.572 (>= (bought goods22) (request goods22)))
(within 1.572 (>= (bought goods23) (request goods23)))
(within 1.572 (>= (bought goods24) (request goods24)))
(within 1.572 (>= (bought goods25) (request goods25)))
(within 1.572 (>= (bought goods26) (request goods26)))))
