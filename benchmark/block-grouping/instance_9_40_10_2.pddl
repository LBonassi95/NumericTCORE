...
(at-most-once (and (>= (x b31) 7) (< (x b31) 10)))
(at-most-once (and (>= (y b31) 7) (< (y b31) 10)))
(at-most-once (and (>= (x b32) 7) (< (x b32) 10)))
(at-most-once (and (>= (y b32) 7) (< (y b32) 10)))
(at-most-once (and (>= (x b33) 7) (< (x b33) 10)))
(at-most-once (and (>= (y b33) 7) (< (y b33) 10)))
(at-most-once (and (>= (x b34) 7) (< (x b34) 10)))
(at-most-once (and (>= (y b34) 7) (< (y b34) 10)))
(at-most-once (and (>= (x b35) 7) (< (x b35) 10)))
(at-most-once (and (>= (y b35) 7) (< (y b35) 10)))
(at-most-once (and (>= (x b36) 7) (< (x b36) 10)))
(at-most-once (and (>= (y b36) 7) (< (y b36) 10)))
(at-most-once (and (>= (x b37) 7) (< (x b37) 10)))
(at-most-once (and (>= (y b37) 7) (< (y b37) 10)))
(at-most-once (and (>= (x b38) 7) (< (x b38) 10)))
(at-most-once (and (>= (y b38) 7) (< (y b38) 10)))
(at-most-once (and (>= (x b39) 7) (< (x b39) 10)))
(at-most-once (and (>= (y b39) 7) (< (y b39) 10)))
(at-most-once (and (>= (x b40) 7) (< (x b40) 10)))
(at-most-once (and (>= (y b40) 7) (< (y b40) 10)))))
