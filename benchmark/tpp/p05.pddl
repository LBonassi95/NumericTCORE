...
(:constraints (and (within 20 (>= (bought goods0) (request goods0)))
(within 20 (>= (bought goods1) (request goods1)))
(within 44 (>= (bought goods2) (request goods2)))
(within 44 (>= (bought goods3) (request goods3)))
(within 44 (>= (bought goods4) (request goods4)))))
