...
(:constraints (and (within 48 (>= (bought goods0) (request goods0)))
(within 48 (>= (bought goods1) (request goods1)))
(within 48 (>= (bought goods2) (request goods2)))
(within 108 (>= (bought goods3) (request goods3)))
(within 108 (>= (bought goods4) (request goods4)))
(within 108 (>= (bought goods5) (request goods5)))))
