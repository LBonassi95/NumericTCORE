...
combinations = [
    (a1, n_cond1, delta_achiever, False),
    (a1, n_cond2, delta_achiever, False),
    (a1, And(n_cond1, n_cond2), delta_achiever, False),
    (a1, Or(n_cond1, n_cond2), delta_achiever, False),
    (a1, And(n_cond1, n_cond3), delta_achiever, False),
    (a1, Or(n_cond1, Not(n_cond3)), delta_achiever, True),
